...
# The method changes the order of a list permanently, but you reverse()
# can revert to the original order anytime by applyingto the same reverse() list a second time. 
cars.reverse()
print(cars)
